<template>
    ...
    <div class="search-rerative d-xl-flex">
    ...
    <div class="row">
      <div v-for="competition in filteredCompetitions" :key="competition.id" class="col-md-4">
        <div class="competition-card text-center ">
          <h3 class="competition-title">{{ competition.competition }}</h3>
    ...
    methods: {
      ...
      filterCompetitions() {
        ...
        if (this.competitionName) { 
          ...
          filtered = filtered.filter((competition) => {
            const lowerCaseCompetition = competition.competition.toLowerCase();
